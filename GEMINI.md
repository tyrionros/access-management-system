# Gemini Context: Access Management System

This document provides a comprehensive overview of the Access Management System (AMS) project. It is intended to be used as a primary context source for development, administration, and support tasks.

## 1. Project Overview

The Access Management System (AMS) is a solution designed to automate and formalize the process of requesting, approving, and auditing user access to Microsoft Dynamics 365 applications. Its primary goals are to improve operational efficiency, enhance the user experience for access requests, and ensure compliance with security standards like ISO 27001.
